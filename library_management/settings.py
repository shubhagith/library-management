...
SECRET_KEY = 'django-insecure-!y4t=otbq8jv&(e(@4d#g)^_q^7jmrcv&xt@42^2ojxp63j-m1'
...
if DB_ENGINE == "mysql":
    ...
    raise ValueError("Unsupported database engine. Set DB_ENGINE to 'mysql' or 'sqlserver' in .env file.")
